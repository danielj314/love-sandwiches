...
def get_sales_data():
    ...
    by commas. The loop will repeat request for data until it is valid.
    """
    while True:
        print("Please enter sales data from the last market.")
        print("Data should be six numbers, separated by commas.")
        print("Example: 10,20,30,40,30,40\n")
...
def calculate_surplus_data(sales_row):
    ...
    -negative surplus undicates extra made when stock was sold out.
    """
...
def update_worksheet(data, worksheet):
    """
    Receives list of integers to be added to worksheet.
...
def calculate_stock_data(data):
    """
    Calculate te average stock for each item type, adding 10%
    """
